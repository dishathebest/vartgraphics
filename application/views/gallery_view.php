...
<script type="text/javascript">
    $(document).ready(function() {
		...
		$( ".a1" ).click(function() {
	$(".cat-toggle i").toggleClass("rotate");
	});
    });
</script>
<div class="vart-container">
 ...
 <div class="panel-group category-list" id="accordion">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" class="a1" data-parent="#accordion" href="#collapse143">Printing</a>  <div class="cat-toggle"><i class="fa fa-caret-right"></i></div>
        </h4>
      </div>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" class="a1" data-parent="#accordion" href="#collapse243">Packaging</a>  <div class="cat-toggle"><i class="fa fa-caret-right"></i></div>
        </h4>
      </div>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" class="a1" data-parent="#accordion" href="#collapse343">Stickers</a>  <div class="cat-toggle"><i class="fa fa-caret-right"></i></div>
        </h4>
      </div>
