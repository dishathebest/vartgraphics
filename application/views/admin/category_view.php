<div class="row">
    <div class="col-lg-12">
        ...
        <div class="form-group">
            ...
            <p class="help-block"></p>
            <?php if ($mode == 'edit' && $categoryDetail->image != '') { ?>
                <img src="<?= ($categoryDetail->image != '' ? $this->config->item('base_url') . "images/category/" . $categoryDetail->image : "") ?>" width="100" />
            <?php } ?>
        </div>
        <div class="form-group">
            <?= form_label('Homepage Image'); ?>
            <?= form_upload(array("name" => "image_home", "id" => "image_home")) ?>
            <p class="help-block"></p>
            <?php if ($mode == 'edit' && $categoryDetail->image_home != '') { ?>
                <img src="<?= ($categoryDetail->image_home != '' ? $this->config->item('base_url') . "images/category/" . $categoryDetail->image_home : "") ?>" width="100" />
            <?php } ?>
        </div>
        <div class="form-group">
