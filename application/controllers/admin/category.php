...
class Category extends CI_Controller {
	...
	$data['categoryDetail'] = $this->category_model->getCategoryList(array("cat_id", "cat_name", "cat_description", "cat_parent_id","active","image_home"), $cat_id);
	...
	$categoryDir = $this->config->item('base_dir') . "images/home_category";
